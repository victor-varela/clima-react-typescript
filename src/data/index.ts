...
export const allCountries = [
  ...
  { id: 180, alpha2: "cd", alpha3: "cod", name: "República Democrática del Congo" },
  ...
  { id: 670, alpha2: "vc", alpha3: "vct", name: "San Vicente y las Granadinas" },
...
export const formatCountries: Country[] = allCountries.map(country => ({
  code: country.alpha2,
  name: country.name,
}));
